...
struct LoginPage : View {
    ...
    //                }
                ...
                .bottomSheet(isPresented: $showBottomSheetLanguageView, height: DefineSize.Screen.Height, topBarCornerRadius: DefineSize.CornerRadius.BottomSheet, content: {
                    BSLanguageView(isShow: $showBottomSheetLanguageView, selectedLangName: $languageManager.languageName, selectedLangCode: languageManager.getTransCode(), isChangeAppLangCode: true, type: .nonType, onClick: {  language in
