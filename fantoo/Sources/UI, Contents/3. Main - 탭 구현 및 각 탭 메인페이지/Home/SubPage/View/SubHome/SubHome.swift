            ...
            VStack(spacing: 0) {
                ...
                if userManager.isGuest {
                    ...
                    LazyVStack(spacing: 0) {
                        if viewModel.listSizeCount > 0 {
                            ForEach(Array(viewModel.mainPostDtoList.enumerated()), id: \.offset) { index, element in
...
//                                }
                                ...
                                BoardRowView(viewType: BoardType.MainHome_Home,
                                             mainHome_home: element,
                                 ...
                                 */
//                                .onChange(of: viewModel.mainPostDtoList) { newValue in
...
//                                }
        ...
        .bottomSheet(
            ...
            content: {
                CustomBottomView(
                    title: popupTitle,
                    type: CustomBottomSheetClickType.SubHomeItemMore,
                    onPressItemMore: { buttonType in
                        switch buttonType {
                        case HomePageItemMoreType.None:
                            print("\(clickedPopupItemPosition)번째 아이템, None 버튼 클릭!")
...
extension SubHome {
    fileprivate func fetchMoreData(_ boardList: MainPostDtoList){
