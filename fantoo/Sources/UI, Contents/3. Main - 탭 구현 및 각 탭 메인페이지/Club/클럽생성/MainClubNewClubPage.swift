...
//                    goBackMainClub = false
    ...
    var clubSettingView: some View {
        VStack(spacing: 0) {
            ...
            //가입 승인 방식
            ListLinkView(text: "g_join_accept_method".localized, subText: joinAcceptSubText, subTextColor: Color.gray800, type: .ClickRight) {
                showSheetJoinMethod = true
            }
            
            //클럽 공개 설정
            ListLinkView(text: "k_club_visibility_settings".localized, subText: clubJoinSubText, subTextColor: Color.gray800, type: .ClickRight) {
                showSheetClubVisibility = true
            }
            
            //주 언어 설정
            ListLinkView(text: "j_main_language_settings".localized, subText: viewModel.languageName, subTextColor: Color.gray800, type: .ClickRight) {
                showSheetLanguageSetting = true
            }
            
            //주 활동국가 설정
            ListLinkView(text: "j_main_activity_contry_settings".localized, subText: viewModel.activeCountryCode, subTextColor: Color.gray800, type: .ClickRight) {
