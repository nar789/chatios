                        ...
                        if viewModel.isLoadingFinish {
                            ...
                            LazyVStack(spacing: 10) {
                                VStack(alignment: .leading, spacing: 0) {
                                    ...
                                    if viewModel.board_hourList.count > 0 {
                                        issueTop5View
                                    } else {
                                        listEmptyView
                                    }
                                ...
                                VStack(alignment: .leading, spacing: 0) {
                                    ...
                                    if viewModel.board_weekList.count > 0 {
                                        weekTop5View
                                    } else {
                                        listEmptyView
                                    }
        ...
        VStack(spacing: 0) {
            HStack(spacing: 0) {
                Image("icon_outline_move_favorite")
                    .onTapGesture {
                        clickFavoritPage = true
                    }
                    .background(
                        NavigationLink("", isActive: $clickFavoritPage) {
    ...
    var noticeView: some View {
        VStack(spacing: 0) {
            HStack(spacing: 0) {
                ...
                if viewModel.communityTotalNoticeList.count > 0 {
                    Text(noticeMore)
                        .font(Font.caption11218Regular)
                        .foregroundColor(Color.gray400)
                        .onTapGesture {
                            showNoticeMoreView = true
                        }
                        .background(
                            NavigationLink("", isActive: $showNoticeMoreView) {
