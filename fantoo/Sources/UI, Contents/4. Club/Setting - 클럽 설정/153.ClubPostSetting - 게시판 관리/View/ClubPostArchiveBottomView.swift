...
struct ClubPostArchiveBottomView: View {
    ...
    var PostVisibilityTitle = [
        subTitleDescription(SEQ: 1, subTitle: "g_open_public".localized, subDescription: "se_b_can_see_non_join".localized),
        subTitleDescription(SEQ: 2, subTitle: "b_hidden".localized, subDescription: "se_g_visible_post".localized)
    ]
    var ArchiveTypeTitle = [
        subTitleDescription(SEQ: 1, subTitle: "a_image".localized, subDescription: "".localized),
        subTitleDescription(SEQ: 2, subTitle: "a_general".localized, subDescription: "d_move_weblink_text".localized)
    ]
