...
struct ClubPostDetailPage: View {
    ...
    @State var clubVisibilityText: String = "j_total_visibility".localized
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            SettingListLinkView(text: "g_board_public_settings".localized, subText: BottomSheetManager.shared.onPressArchiveTypeTitle, lang: "", type: .ClickRight, showLine: true) {
                //자유게시판은 공개 설정 변경 불가함
