...
struct ClubMyProfileSettingPage: View {
    ...
    @StateObject var vm = ClubMyProfileSettingViewModel()
    ...
    var body: some View {
        ...
        .showAlert(isPresented: $showAlertEditCancel, type: .Default, title: "", message: "se_p_cancel_modify_profile".localized, detailMessage: "", buttons: ["c_cancel".localized, "h_confirm".localized], onClick: { buttonIndex in
            if buttonIndex == 1 {
