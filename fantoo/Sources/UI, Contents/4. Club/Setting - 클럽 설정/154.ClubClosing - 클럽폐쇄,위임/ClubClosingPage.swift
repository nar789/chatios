...
struct ClubClosingPage: View {
    ...
    private struct sizeInfo {
        ...
        static let spacing22: CGFloat = 22.0
    ...
    var body: some View {
        VStack(spacing: 0) {
            ...
            if changePage {
                ...
                if clubClosingType == .BeforeClubClosing {
                }
            ...
            if changePage {
                ...
                Button {
                    ...
                    CommonButton(title: clubClosingType == .BeforeClubClosing ? "k_close_club".localized : "k_cancel_close_club".localized, bgColor: clubClosingType == .BeforeClubClosing ? Color.stateEnableGray200 : Color.stateActivePrimaryDefault)
                        .padding([.horizontal, .bottom], DefineSize.Contents.HorizontalPadding)
        ...
        .showAlert(isPresented: $showClubClosing, type: .Default, title: "k_club_closure".localized, message: "se_k_want_to_close_club".localized, detailMessage: "", buttons: ["a_no".localized, "a_yes".localized], onClick: { button in
            if button == 1 {
                changePage = true
                vm.requestClubClosingRequest(clubId: clubId)
            }
        })
        .showAlert(isPresented: $showCancelClosing, type: .Default, title: "k_cancel_close_club".localized, message: "se_k_do_you_cancel_close_club".localized, detailMessage: "", buttons: ["a_no".localized, "a_yes".localized], onClick: { button in
            ...
            vm.requestClubClosingCancel(clubId: clubId)
        })
...
extension ClubClosingPage {
    ...
    var confirmClubClosing: some View {
        VStack(alignment: .leading) {
            ...
            Text("p_date_will_closed_date".localized + " \(commonDate(for: vm.date))")
                .font(Font.body21420Regular)
                .foregroundColor(Color.primary500)
                .multilineTextAlignment(.leading)
        }
        .padding(.top, sizeInfo.padding20)
