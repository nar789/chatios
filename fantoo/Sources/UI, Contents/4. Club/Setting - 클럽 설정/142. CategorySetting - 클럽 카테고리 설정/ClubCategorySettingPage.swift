...
struct ClubCategorySettingPage: View {
    ...
    var body: some View {
        ...
        .navigationType(leftItems: [.Back], rightItems: [.PurpleDone], leftItemsForegroundColor: .black, rightItemsForegroundColor: completeState ? Color.primary500 : Color.black, title: "k_club_info_setting".localized, onPress: { buttonType in
            if completeState {
                vm.requestClubInfoEdit(clubId: clubId, integUid: UserManager.shared.uid, interestCategoryId: selectedCode, memberCountOpenYn: vm.memberCountOpenYn, memberJoinAutoYn: vm.memberJoinAutoYn, memberListOpenYn: vm.memberListOpenYn, openYn: vm.openYn) { success in
...
struct ClubCategorySettingPage_Previews: PreviewProvider {
    static var previews: some View {
        ClubCategorySettingPage(clubId: .constant(""), interests: .constant(1))
    }
}
