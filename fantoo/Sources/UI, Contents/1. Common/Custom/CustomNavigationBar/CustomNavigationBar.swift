        ...
        content
            ...
            .navigationBarItems(
                leading: HStack(spacing: 0) {
                    if isShowSearchBar {
//                        CustomFocusTextField(placeholder: placeholder, isFirstResponder: true, text: $searchText, correctStatus: .constant(.Check), isKeyboardEnter: $isKeyboardEnter, type: .Search)
