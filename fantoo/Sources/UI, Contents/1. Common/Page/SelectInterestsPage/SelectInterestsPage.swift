...
struct SelectInterestsPage: View {
    ...
    var body: some View {
        ...
        .navigationType(leftItems: leftItems, rightItems: vm.selectedInterests.count > 0 ? rightItems : unSaveRightItems, leftItemsForegroundColor: .black, rightItemsForegroundColor: vm.selectedInterests.count > 0 ? .primary500 : .gray300, title: "g_select_interests".localized, onPress: { buttonType in
            if buttonType == .Save {
                if vm.selectedInterests.count > 0 {
