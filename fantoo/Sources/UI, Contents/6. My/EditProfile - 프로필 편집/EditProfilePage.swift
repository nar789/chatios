...
struct EditProfilePage: View {
    ...
    var body: some View {
        VStack {
            ...
            .navigationType(leftItems: [.Back], rightItems: [], leftItemsForegroundColor: .black, rightItemsForegroundColor: .black, title: "p_setting_profile".localized, onPress: { buttonType in
                if buttonType == .Back {
                }
            })
