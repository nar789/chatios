...
struct WalletFanitDetailPage: View {
    ...
    var body: some View {
        ...
        .navigationType(leftItems: [.Close], rightItems: [], leftItemsForegroundColor: .black, rightItemsForegroundColor: .black, title: "g_coffer".localized, onPress: { buttonType in
