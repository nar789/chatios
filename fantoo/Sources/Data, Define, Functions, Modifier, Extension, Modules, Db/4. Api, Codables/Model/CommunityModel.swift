...
//struct MainCommunity_Board_Hour: Codable, Hashable {
//    /**
//     * 비회원 / 회원 의 응답 값 차이는
//     * 아래에서 옵셔널로 처리한 변수들이다.
//     * 즉, 비회원도 동일한 모델을 사용하도록 하기 위해서 옵셔널로 적용했음.
//     */
//    let postId, activeStatus, likeCnt, dislikeCnt, honorCnt, replyCnt: Int
//    let code, subCode, title, content, integUid, langCode, userNick, userPhoto, categoryImage, createDate: String
//    let anonymYn, likeYn, dislikeYn: Bool
//    let userBlockYn, pieceBlockYn: Bool?
//}
struct Community_BoardItem: Codable, Hashable {
    ...
    let userBlockYn, pieceBlockYn, bookmarkYn: Bool?
}
