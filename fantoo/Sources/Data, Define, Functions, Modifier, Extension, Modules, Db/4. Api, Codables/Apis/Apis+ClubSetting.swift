...
enum ApisClubSetting {
    ...
    case ClubMemberBookmarkList(clubId: String, integUid: String, memberId: String, nextId: String, size: String)
    ...
    case ClubDelegateMember0(clubId: String, integUid: String)
    case ClubDelegateMember0_Ok(clubId: String, integUid: String)
    case ClubDelegateMember0_No(clubId: String, integUid: String)
}
...
extension ApisClubSetting: Moya.TargetType {
    ...
    var path: String {
        ...
        case .ClubMemberBookmarkList(let clubId, _, let memberId, _, _):
            return "club/" + clubId + "/storage/member/" + memberId + "/bookmark"
        ...
        case .ClubBlockCheck(let clubId, let memberId, _):
            return "club/" + clubId + "/block/member/" + memberId
        case .ClubDelegateMember0(let clubId, _):
            return "club/\(clubId)/delegate/member/0"
        case .ClubDelegateMember0_Ok(let clubId, _):
            return "club/\(clubId)/delegate/member/0/ok"
        case .ClubDelegateMember0_No(let clubId, _):
            return "club/\(clubId)/delegate/member/0/no"
        }
    }
    ...
    var method: Moya.Method {
        ...
        case .ClubBlockCheck:
            return .patch
        case .ClubDelegateMember0_Ok:
            return .patch
        case .ClubDelegateMember0_No:
            return .patch
        default:
            return .get
        }
    ...
    var task: Task {
        ...
        case .ClubMemberBookmarkList(_, let integUid, _, let nextId, let size):
            var params = defultParams
            params["integUid"] = integUid
            params["nextId"] = nextId
            params["size"] = size
        ...
        case .ClubDelegateMember0(_, let integUid):
            var params = defultParams
            params["integUid"] = integUid
            log(params: params)
            return .requestParameters(parameters: params, encoding: URLEncoding.default)
            
        case .ClubDelegateMember0_Ok(_, let integUid):
            var params = defultParams
            params["integUid"] = integUid
            log(params: params)
            return .requestParameters(parameters: params, encoding: JSONEncoding.default)
            
        case .ClubDelegateMember0_No(_, let integUid):
            var params = defultParams
            params["integUid"] = integUid
            log(params: params)
            return .requestParameters(parameters: params, encoding: JSONEncoding.default)
