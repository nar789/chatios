...
//        .remote(url: "https://github.com/twostraws/CodeScanner", requirement: .upToNextMajor(from: "2.0.0")),
        ...
        .remote(url: "https://github.com/Jake-Short/swiftui-image-viewer.git", requirement: .upToNextMajor(from: "2.3.1")),
        .remote(url: "https://github.com/DominikButz/SwipeCellSUI", requirement: .upToNextMajor(from: "2.1.3")),
        .remote(url: "https://github.com/socketio/socket.io-client-swift", requirement: .upToNextMajor(from: "15.2.0"))
    ],
    platforms: [.iOS]
)
